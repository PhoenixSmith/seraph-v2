...
export function MemberHoverCard({ userId, userName, avatarConfig, children }: MemberHoverCardProps) {
  ...
  return (
    ...
    >
      ...
      {isOpen && (
        <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 z-[100] w-72 rounded-lg border bg-popover text-popover-foreground shadow-lg overflow-hidden">
